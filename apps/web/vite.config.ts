...
export default defineConfig({
  ...
  build: {
    sourcemap: true,
    rollupOptions: {
      // Keep the existing desktop entry at `/` and publish the mobile shell
      // as an independent document so its UI and boot path can evolve without
      // changing the production desktop surface.
      input: {
        index: src('../web/index.html'),
        mobile: src('../web/mobile.html'),
      },
      output: {
