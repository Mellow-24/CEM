...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  skills: 'skills.md',
  speechSynthesis: 'speech.md',
  speechTranscription: 'speech.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ResolvedSpeechSynthesis: 'speech.md',
  ResolvedSpeechTranscription: 'speech.md',
  SpeechAudioMetadata: 'speech.md',
  SpeechSynthesisInput: 'speech.md',
  SpeechSynthesisOutput: 'speech.md',
  SpeechSynthesisProfile: 'speech.md',
  SpeechSynthesisProvider: 'speech.md',
  SpeechTranscript: 'speech.md',
  SpeechTranscriptionInput: 'speech.md',
  SpeechTranscriptionProfile: 'speech.md',
  SpeechTranscriptionProvider: 'speech.md',
