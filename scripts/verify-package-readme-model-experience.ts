...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-response-language': { kind: 'indirect', reason: 'The selector dispatches /response-language; dsh-response-language owns the durable preference, resolution, and model-visible policy.' },
  'packages/client/ui-voice': { kind: 'indirect', reason: 'Voice send submits transcript text through ui-conversation; recording, synthesis, and playback add no model context.' },
  ...
  'packages/client/ui-customer-portal': { kind: 'indirect', reason: 'The customer controls submit ordinary Session prompts; the selected agent preset owns model-facing composition.' },
  'packages/client/ui-mobile-chat': { kind: 'indirect', reason: 'Mobile controls submit ordinary Session prompts; Host speech and agent presets own model-facing composition.' },
  ...
  'packages/speech/speech-transcription': { kind: 'none', reason: 'The registry returns transcript text to its Consumer and never inserts it into a model request.' },
  'packages/speech/speech-synthesis': { kind: 'none', reason: 'The registry renders already-committed assistant text to humans and never changes model input or output.' },
  'packages/speech/speech-dashscope': { kind: 'none', reason: 'The provider translates committed text to DashScope synthesis requests and never changes model context.' },
  'packages/speech/speech-ministream': { kind: 'none', reason: 'The provider translates committed text to MiniStream synthesis requests and never changes model context.' },
  'packages/speech/speech-http': { kind: 'none', reason: 'The providers translate speech operations to HTTP and never assemble or modify a model request.' },
