/**
 * Layout plugin, browser half: one register() call contributes the frame into
...
/**
 * Client plugin body: provide ctx.layout, then register the document's frame
...
export function apply(ctx: ClientContext): void {
  ...
  const Frame = document.documentElement.hasAttribute('data-dsh-mobile') ? MobileFrame : AppFrame
  ctx.effect(() => {
