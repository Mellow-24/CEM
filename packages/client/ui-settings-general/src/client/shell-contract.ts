...
/** Section id whose presence activates the customer-service operations console. */
export const CUSTOMER_SERVICE_OVERVIEW_SECTION_ID = 'customer-service-overview'
...
export type SettingsRootInjected = {
  /** Resolve shell-owned operations copy against the current locale. */
 ...
 * (hooks compartment bound to useSections). No store is registered — console
 * visibility and active section id are component-local viewing state.
 */
