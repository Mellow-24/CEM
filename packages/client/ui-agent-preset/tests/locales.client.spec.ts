...
describe('preset display copy', () => {
  it.each([
    ...
    ['macau-customer-service', 'presetMacauCustomerServiceName', 'presetMacauCustomerServiceDescription'],
    ['macau-customer-service-wiki', 'presetMacauCustomerServiceWikiName', 'presetMacauCustomerServiceWikiDescription'],
    ['hk-feng-shui', 'presetHongKongFengShuiName', 'presetHongKongFengShuiDescription'],
