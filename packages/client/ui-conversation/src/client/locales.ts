...
/** Simplified Chinese app copy; the Macau operations settings row uses Traditional Chinese. */
export const zh = {
  'view.chat': '对话',
  ...
  'settings.enter.description': '僅在智能體運行時生效；Cmd/Ctrl+Enter 使用另一行為',
...
export const en = {
  ...
  'hero.headline': 'Shenyi Future',
  'hero.preview': 'Intelligent Service Platform',
