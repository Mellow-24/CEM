 ...
 * stores. `close` leaves the console; optional `navigate` selects another
 * registered section without closing the console.
 */
export interface SettingsSectionOwnerProps {
  /** Close the settings panel (the shell owns the open state). */
  close: () => void
  /** Navigate within the console when the hosting shell supports linked sections. */
