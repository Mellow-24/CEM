...
Section owners provide `close()` and optional `navigate(id)` callbacks. Linked operations pages navigate without closing the console; each feature retains its injected data and stores.
