...
import { OperationsTrace } from './OperationsTrace.tsx'
export type {} from './OperationsTrace.tsx'
...
export function apply(ctx: Context): void {
  ctx.slots.inject('operations.trace', () => ctx.slots.register({ name: 'operations.trace' }, OperationsTrace))
