...
/**
 * No runtime invariant: the Host speech package validates profile authority;
 * this package owns reversible slot registrations and per-session browser
 * resources whose component and controller tests prove disposal.
 */
