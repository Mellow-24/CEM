...
| [`ui-response-language/`](ui-response-language/README.md) | Selects the reply language for sessions whose agent preset contributes the policy. |
...
| [`ui-customer-service-admin/`](ui-customer-service-admin/README.md) | Contributes the Macau customer-service operations overview, knowledge, conversations, and evaluation pages. |
| [`ui-customer-portal/`](ui-customer-portal/README.md) | Provides the CEM-branded customer conversation route over the shared Session service. |
