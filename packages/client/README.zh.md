...
| [`ui-response-language/`](ui-response-language/README.md) | 为 agent 预设提供该策略的会话选择回复语言。 |
...
| [`ui-customer-service-admin/`](ui-customer-service-admin/README.md) | 贡献澳门电力智能客服的运营总览、知识库、会话与评测页面。 |
| [`ui-customer-portal/`](ui-customer-portal/README.md) | 基于共享会话服务提供采用澳电品牌视觉的客户对话入口。 |
