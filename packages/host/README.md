...
| [`customer-service-admin/`](customer-service-admin/README.md) | Local-only operational projection, staged-source admission, retrieval tests, and evaluation records for Macau customer service | Remote `customerServiceAdmin/*` |
