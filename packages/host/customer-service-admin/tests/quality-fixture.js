...
import { LlmAdapter, CallId, ReasoningEffortId, createMessage, createToolResultMessage, createUserMessage } from '@deepseek-ai/dsh-llm';
import { qualityDimensions } from "../src/quality-schema.js";
export function seedQualityConversation(session) {
    ...
    session.append('tool/result', { turn: 1, step: 1, message: createToolResultMessage({ callId: CallId('quality-search'),
            content: [{ type: 'text', text: '{"sources":[{"title":"繳費方式","excerpt":"可通過澳電 App 繳費。","score":0.8}]}' }], isError: false }) }, { surfaceOp: 'append' });
...
//# sourceMappingURL=quality-fixture.js.map