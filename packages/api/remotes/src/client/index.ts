...
import customerServiceAdminRemote from '@deepseek-ai/dsh-host-customer-service-admin/remote'
export type { QualityInspection, QualityTraceRecord, QualityRun, QualityRunId, QualityRunSummary,
  QualityDimension, QualityScore, QualityTurnResult, QualityReview, QualityStartRequest,
  QualityReviewRequest } from '@deepseek-ai/dsh-host-customer-service-admin/types'
...
} from '@deepseek-ai/dsh-host-customer-service-admin/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-customer-service-admin/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, customerServiceAdminRemote,
