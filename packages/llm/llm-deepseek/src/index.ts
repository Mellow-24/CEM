...
const DEFAULT_MODELS: DeepSeekCatalogModel[] = [
  { id: 'deepseek-v4-flash', name: '深绎·迅捷', contextWindow: DEFAULT_CONTEXT_WINDOW },
  { id: 'deepseek-v4-pro', name: '深绎·远见', contextWindow: DEFAULT_CONTEXT_WINDOW },
]
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.llm.registerConfigurableProviders([
    { provider: PROVIDER, displayName: '深绎未来模型服务', settingsNs: NS, settingsPath: [] },
  ])
