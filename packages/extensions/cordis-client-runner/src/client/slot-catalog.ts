...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-voice VoicePlaybackAction id \'voice-playback\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-voice VoiceStatus id \'voice-status\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-response-language ResponseLanguageSelect id \'response-language\'',
      'client-ui-voice VoiceInputButton id \'voice-input\'',
      'client-ui-voice VoiceCallButton id \'voice-call\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'customer-admin.page',
    kind: 'keyed',
    scope: 'root',
    summary: 'One keyed business page rendered by the standalone operations shell.',
    doc: 'One keyed business page rendered by the standalone operations shell.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-customer-service-admin), so it exists while that entry is mounted',
    occupants: [
      'client-ui-customer-service-admin PortalQualitySessionsPage',
      'client-ui-customer-service-admin QualityQueuePage',
      'client-ui-customer-service-admin OperationsSection',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'customer-admin.page\', () => ctx.slots.register(\n      { name: \'customer-admin.page\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-customer-service-admin/src/client/customer-admin-contract.ts:8',
  },
  {
    key: 'details',
    kind: 'single',
  ...
  {
    key: 'mobile-chat.conversation',
    kind: 'single',
    scope: 'session',
    summary: 'Complete CEM Session view, including draft, history, and media controls.',
    doc: 'Complete CEM Session view, including draft, history, and media controls. No owner props;\nregistrants receive the Session runtime kit. A replacement owns the entire view;\nwithout a registration the mobile root has no conversation content.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-mobile-chat), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mobile-chat MobileConversation',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'mobile-chat.conversation\', () => ctx.slots.register(\n      { name: \'mobile-chat.conversation\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mobile-chat/src/client/index.ts:21',
  },
  {
    key: 'operations.trace',
    kind: 'single',
    scope: 'root',
    summary: 'Host-inspected events, independent of the currently active conversation.',
    doc: 'Host-inspected events, independent of the currently active conversation.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.section\' (client-ui-customer-service-admin), so it exists while that entry is mounted',
    occupants: [
      'client-ui-trajectory OperationsTrace',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'operations.trace\', () => ctx.slots.register(\n      { name: \'operations.trace\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-trajectory/src/client/OperationsTrace.tsx:11',
  },
  {
    key: 'root',
    kind: 'single',
    ...
    occupants: [
      'client-ui-customer-portal CustomerPortal',
      'client-ui-customer-service-admin CustomerAdminPortal',
      'client-ui-layout Frame',
      'client-ui-mobile-chat MobileChatRoot',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-customer-service-admin QualitySessionsPage id \'customer-service-sessions\'',
      'client-ui-customer-service-admin QualityQueuePage id \'customer-service-evaluation\'',
      'client-ui-customer-service-admin OperationsSection',
