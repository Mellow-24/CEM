...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_customer_service_admin["client-ui-customer-service-admin"]
    ...
    pkg_client_ui_response_language["client-ui-response-language"]
  ...
  subgraph group_context["packages/context"]
    ...
    pkg_response_language["response-language"]
  ...
  subgraph group_host["packages/host"]
    ...
    pkg_host_customer_service_admin["host-customer-service-admin"]
  ...
  subgraph group_preset["packages/preset"]
    ...
    pkg_customer_service_knowledge["customer-service-knowledge"]
    pkg_customer_service_wiki["customer-service-wiki"]
    pkg_persona["persona"]
  end
  ...
  subgraph group_speech["packages/speech"]
    pkg_speech_dashscope["speech-dashscope"]
    pkg_speech_http["speech-http"]
    pkg_speech_ministream["speech-ministream"]
    pkg_speech_synthesis["speech-synthesis"]
    pkg_speech_transcription["speech-transcription"]
    pkg_speech_web["speech-web"]
  end
  ...
  pkg_speech_synthesis --> pkg_agent
  pkg_speech_synthesis --> pkg_invariants
  pkg_speech_synthesis --> pkg_scope
  pkg_speech_transcription --> pkg_agent
  pkg_speech_transcription --> pkg_invariants
  pkg_speech_transcription --> pkg_scope
  ...
  pkg_response_language --> pkg_agent
  pkg_response_language --> pkg_commands
  pkg_response_language --> pkg_invariants
  pkg_response_language --> pkg_llm
  pkg_response_language --> pkg_scope
  pkg_response_language --> pkg_session
  pkg_response_language --> pkg_session_projection
  pkg_response_language --> pkg_system_prompt
  ...
  pkg_speech_dashscope --> pkg_credentials
  pkg_speech_dashscope --> pkg_invariants
  pkg_speech_dashscope --> pkg_speech_synthesis
  pkg_speech_dashscope --> pkg_timeout
  pkg_speech_http --> pkg_credentials
  pkg_speech_http --> pkg_invariants
  pkg_speech_http --> pkg_speech_synthesis
  pkg_speech_http --> pkg_speech_transcription
  pkg_speech_http --> pkg_timeout
  pkg_speech_ministream --> pkg_credentials
  pkg_speech_ministream --> pkg_invariants
  pkg_speech_ministream --> pkg_speech_synthesis
  ...
  pkg_customer_service_knowledge --> pkg_invariants
  pkg_customer_service_knowledge --> pkg_system_prompt
  pkg_customer_service_knowledge --> pkg_tools
  pkg_customer_service_wiki --> pkg_invariants
  pkg_customer_service_wiki --> pkg_system_prompt
  pkg_customer_service_wiki --> pkg_tools
  ...
  pkg_speech_web --> pkg_agent
  pkg_speech_web --> pkg_client_connection
  pkg_speech_web --> pkg_invariants
  pkg_speech_web --> pkg_llm_retry
  pkg_speech_web --> pkg_response_language
  pkg_speech_web --> pkg_session
  pkg_speech_web --> pkg_speech_synthesis
  pkg_speech_web --> pkg_speech_transcription
  pkg_speech_web --> pkg_system_prompt
  ...
  pkg_host_customer_service_admin --> pkg_brand
  pkg_host_customer_service_admin --> pkg_customer_service_knowledge
  pkg_host_customer_service_admin --> pkg_customer_service_wiki
  pkg_host_customer_service_admin --> pkg_invariants
  pkg_host_customer_service_admin --> pkg_llm
  pkg_host_customer_service_admin --> pkg_session
  pkg_host_customer_service_admin --> pkg_session_persistence
  pkg_host_customer_service_admin --> pkg_typert_protocol
  ...
  pkg_api_remotes --> pkg_host_customer_service_admin
  ...
  pkg_client_ui_trajectory --> pkg_api_remotes
  ...
  pkg_client_ui_customer_service_admin --> pkg_api_remotes
  pkg_client_ui_customer_service_admin --> pkg_client_connection
  pkg_client_ui_customer_service_admin --> pkg_client_locale
  pkg_client_ui_customer_service_admin --> pkg_client_runtime
  pkg_client_ui_customer_service_admin --> pkg_client_ui_settings
  pkg_client_ui_customer_service_admin --> pkg_client_ui_slots
  pkg_client_ui_customer_service_admin --> pkg_client_ui_trajectory
  pkg_client_ui_customer_service_admin --> pkg_invariants
  ...
  pkg_client_ui_response_language --> pkg_api_remotes
  pkg_client_ui_response_language --> pkg_client_locale
  pkg_client_ui_response_language --> pkg_client_runtime
  pkg_client_ui_response_language --> pkg_client_ui_conversation
  pkg_client_ui_response_language --> pkg_client_ui_primitives
  pkg_client_ui_response_language --> pkg_client_ui_slots
  pkg_client_ui_response_language --> pkg_invariants
  pkg_client_ui_response_language --> pkg_response_language
  ...
  pkg_client_ui_voice --> pkg_client_connection
  pkg_client_ui_voice --> pkg_client_locale
  pkg_client_ui_voice --> pkg_client_runtime
  pkg_client_ui_voice --> pkg_client_ui_conversation
  pkg_client_ui_voice --> pkg_client_ui_primitives
  pkg_client_ui_voice --> pkg_client_ui_slots
  pkg_client_ui_voice --> pkg_invariants
  pkg_client_ui_voice --> pkg_response_language
...
| [`speech-synthesis`](../packages/speech/speech-synthesis) | `speech` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`scope`](../packages/core/scope) |
| [`speech-transcription`](../packages/speech/speech-transcription) | `speech` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`scope`](../packages/core/scope) |
...
| [`speech-dashscope`](../packages/speech/speech-dashscope) | `speech` | [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`speech-synthesis`](../packages/speech/speech-synthesis), [`timeout`](../packages/util/timeout) |
| [`speech-http`](../packages/speech/speech-http) | `speech` | [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`speech-synthesis`](../packages/speech/speech-synthesis), [`speech-transcription`](../packages/speech/speech-transcription), [`timeout`](../packages/util/timeout) |
| [`speech-ministream`](../packages/speech/speech-ministream) | `speech` | [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`speech-synthesis`](../packages/speech/speech-synthesis) |
...
| [`customer-service-knowledge`](../packages/preset/customer-service-knowledge) | `preset` | [`invariants`](../packages/runtime-diagnostics/invariants), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| [`customer-service-wiki`](../packages/preset/customer-service-wiki) | `preset` | [`invariants`](../packages/runtime-diagnostics/invariants), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`speech-web`](../packages/speech/speech-web) | `speech` | [`agent`](../packages/core/agent), [`client-connection`](../packages/client/connection), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm-retry`](../packages/llm/llm-retry), [`response-language`](../packages/context/response-language), [`session`](../packages/core/session), [`speech-synthesis`](../packages/speech/speech-synthesis), [`speech-transcription`](../packages/speech/speech-transcription), [`system-prompt`](../packages/core/system-prompt) |
...
| [`host-customer-service-admin`](../packages/host/customer-service-admin) | `host` | [`brand`](../packages/util/brand), [`customer-service-knowledge`](../packages/preset/customer-service-knowledge), [`customer-service-wiki`](../packages/preset/customer-service-wiki), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`typert-protocol`](../packages/typert/protocol) |
...
| [`api-remotes`](../packages/api/remotes) | `api` | [`agent`](../packages/core/agent), [`agent-presets`](../packages/preset/agent-presets), [`api-gateway`](../packages/api/gateway), [`commands`](../packages/interaction/commands), [`cordis-host-runner`](../packages/extensions/cordis-host-runner), [`credentials`](../packages/credentials/credentials), [`goal`](../packages/goal/goal), [`host-customer-service-admin`](../packages/host/customer-service-admin), [`host-plugin-inventory`](../packages/host/plugin-inventory), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`message-feedback`](../packages/feedback/message-feedback), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`settings`](../packages/settings/settings), [`typert-registry`](../packages/typert/registry) |
...
| [`client-ui-customer-service-admin`](../packages/client/ui-customer-service-admin) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-slots`](../packages/client/ui-slots), [`client-ui-trajectory`](../packages/client/ui-trajectory), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-response-language`](../packages/client/ui-response-language) | `client` | [`api-remotes`](../packages/api/remotes), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants), [`response-language`](../packages/context/response-language) |
...
| [`client-ui-voice`](../packages/client/ui-voice) | `client` | [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants), [`response-language`](../packages/context/response-language) |
