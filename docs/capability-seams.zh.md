...
flowchart LR
  ...
  svc_speechTranscription["ctx.speechTranscription<br/>Scoped complete-recording transcription"]
  pkg_speech_http["speech-http"]
  pkg_speech_web["speech-web"]
  pkg_speech_synthesis["speech-synthesis"]
  svc_speechSynthesis["ctx.speechSynthesis<br/>Scoped bounded speech synthesis"]
  ...
  pkg_speech_dashscope --> svc_speechSynthesis
  pkg_speech_http --> svc_speechSynthesis
  pkg_speech_http --> svc_speechTranscription
  pkg_speech_ministream --> svc_speechSynthesis
  pkg_speech_synthesis --> svc_speechSynthesis
  pkg_speech_transcription --> svc_speechTranscription
  ...
  svc_speechSynthesis --> pkg_speech_web
  svc_speechTranscription --> pkg_speech_web
...
| `ctx.speechTranscription` | `seam` | [`speech-transcription`](../packages/speech/speech-transcription) | [`speech-http`](../packages/speech/speech-http) | [`speech-web`](../packages/speech/speech-web) | - | 预设作用域内的提供方把已准入录音转换成最终文本；Web Consumer 让原始音频留在 Session 历史之外，普通提示词只持久化已接受的 transcript。 |
| `ctx.speechSynthesis` | `seam` | [`speech-synthesis`](../packages/speech/speech-synthesis) | [`speech-dashscope`](../packages/speech/speech-dashscope), [`speech-http`](../packages/speech/speech-http), [`speech-ministream`](../packages/speech/speech-ministream) | [`speech-web`](../packages/speech/speech-web) | - | 预设作用域内的提供方流式输出有界编码音频；Web Consumer 只接受已提交 assistant 消息 id，并在 Host 上解析其文本。 |
