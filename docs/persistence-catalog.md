...
<a id="customer-servicequality-request--log-only"></a>

#### `customer-service/quality-request` — log-only
...
Source: [`packages/host/customer-service-admin/src/quality-engine.ts:21`](../packages/host/customer-service-admin/src/quality-engine.ts)

### `customer-service-knowledge/*`

<a id="customer-service-knowledgeretrieval--log-only"></a>

#### `customer-service-knowledge/retrieval` — log-only
...
Source: [`packages/preset/customer-service-knowledge/src/index.ts:61`](../packages/preset/customer-service-knowledge/src/index.ts)
...
Source: [`packages/context/response-language/src/index.ts:86`](../packages/context/response-language/src/index.ts)
...
Source: [`packages/context/response-language/src/index.ts:88`](../packages/context/response-language/src/index.ts)

<a id="response-languageretry--log-only"></a>

#### `response-language/retry` — log-only
...
Source: [`packages/context/response-language/src/index.ts:90`](../packages/context/response-language/src/index.ts)
