...
Source: [`packages/preset/customer-service-knowledge/src/index.ts:34`](../packages/preset/customer-service-knowledge/src/index.ts)
...
Source: [`packages/preset/customer-service-wiki/src/index.ts:23`](../packages/preset/customer-service-wiki/src/index.ts)
...
Requires: `agents` · `sessions` · `systemPrompt`
...
Source: [`packages/context/response-language/src/index.ts:95`](../packages/context/response-language/src/index.ts)
...
Source: [`packages/speech/speech-dashscope/src/index.ts:57`](../packages/speech/speech-dashscope/src/index.ts)
...
Source: [`packages/speech/speech-http/src/index.ts:71`](../packages/speech/speech-http/src/index.ts)

<a id="deepseek-aidsh-speech-web"></a>

## `@deepseek-ai/dsh-speech-web`

Requires: `connection` · `agents` · `systemPrompt`
...
Source: [`packages/speech/speech-web/src/index.ts:49`](../packages/speech/speech-web/src/index.ts)
...
- `@deepseek-ai/dsh-speech-synthesis` — requires `agents` ([`packages/speech/speech-synthesis/src/index.ts`](../packages/speech/speech-synthesis/src/index.ts))
- `@deepseek-ai/dsh-speech-transcription` — requires `agents` ([`packages/speech/speech-transcription/src/index.ts`](../packages/speech/speech-transcription/src/index.ts))
