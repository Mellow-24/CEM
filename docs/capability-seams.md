...
| `ctx.speechTranscription` | `seam` | [`speech-transcription`](../packages/speech/speech-transcription) | [`speech-http`](../packages/speech/speech-http) | [`speech-web`](../packages/speech/speech-web) | - | Preset-scoped providers turn admitted recordings into final text; the Web Consumer keeps raw audio outside Session history and ordinary prompts persist only the accepted transcript. |
| `ctx.speechSynthesis` | `seam` | [`speech-synthesis`](../packages/speech/speech-synthesis) | [`speech-dashscope`](../packages/speech/speech-dashscope), [`speech-http`](../packages/speech/speech-http), [`speech-ministream`](../packages/speech/speech-ministream) | [`speech-web`](../packages/speech/speech-web) | - | Preset-scoped providers stream bounded encoded audio; the Web Consumer accepts only committed assistant message ids and resolves their text on the Host. |
