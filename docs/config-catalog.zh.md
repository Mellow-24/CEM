...
export interface ConnectionConfig {
   ...
   */
  trustedHosts?: string[]
  /** Maximum buffered body for every `/api` request before an exact raw route applies a smaller cap. */
...
<a id="deepseek-aidsh-customer-service-knowledge"></a>

## `@deepseek-ai/dsh-customer-service-knowledge`
...
export interface KnowledgeConfig {
  ...
  /** Minimum normalized question length eligible for an exact FAQ-heading match. */
...
来源：[`packages/preset/customer-service-knowledge/src/index.ts:34`](../packages/preset/customer-service-knowledge/src/index.ts)
...
来源：[`packages/preset/customer-service-wiki/src/index.ts:23`](../packages/preset/customer-service-wiki/src/index.ts)
...
需要：`agents` · `sessions` · `systemPrompt`
...
来源：[`packages/context/response-language/src/index.ts:80`](../packages/context/response-language/src/index.ts)
...
<a id="deepseek-aidsh-speech-dashscope"></a>
...
来源：[`packages/speech/speech-dashscope/src/index.ts:56`](../packages/speech/speech-dashscope/src/index.ts)

<a id="deepseek-aidsh-speech-http"></a>
...
来源： [`packages/speech/speech-http/src/index.ts:71`](../packages/speech/speech-http/src/index.ts)

<a id="deepseek-aidsh-speech-web"></a>

## `@deepseek-ai/dsh-speech-web`

依赖： `connection` · `agents` · `systemPrompt`
...
export interface Config {
  ...
  call?: Omit<SpeechCallOptions, 'greetings'> & {
...
来源： [`packages/speech/speech-web/src/index.ts:49`](../packages/speech/speech-web/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-response-language`（[`packages/client/ui-response-language/src/index.ts`](../packages/client/ui-response-language/src/index.ts)）
...
- `@deepseek-ai/dsh-speech-synthesis` — 需要 `agents`（[`packages/speech/speech-synthesis/src/index.ts`](../packages/speech/speech-synthesis/src/index.ts)）
- `@deepseek-ai/dsh-speech-transcription` — 需要 `agents`（[`packages/speech/speech-transcription/src/index.ts`](../packages/speech/speech-transcription/src/index.ts)）
